...
class ConvCBP(object):
    ...
    def save_states(self):
        self.gnt.save_states()



    def learn(self, x, target, task_id = -1, epoch_id=-1):
        """
        ...
        self.gnt.gen_and_test(features=self.previous_features, task_id = task_id, epoch_id = epoch_id)
